% !TeX TXS-program:compile = txs:///arar% arara: pdflatex: {shell: yes, synctex: no, interaction: batchmode}
...
\begin{center}
\begin{GrilleSutom}[Arrondi=0,Style=alt,Couleurs={lightgray,orange,teal},Unite=0.5,Lettres=false]{REBUS}
	ABRIS
	ROUTE
	RUDES
	REBUS
...
\hspace{5mm}
%
\begin{GrilleSutom}[Arrondi=0,Style=alt,Couleurs={lightgray,orange,teal},Unite=0.5]{REBUS}
	ABRIS
	ROUTE
	RUDES
	REBUS
...
\verb|v0.2.0|~:~~~~Fusion des codes d'Andrew Mathas

\verb|v0.1.1|~:~~~~Correction d'un bug avec la version anglaise.
...
\begin{DemoCode}[]
\begin{GrilleSutom}%
		[Style=alt,Unite=0.75,Arrondi=0,%
		Couleurs={cyan,orange,violet},Lettres=false]{REBUS}
	ABRIS
	ROUTE
	RUDES
	REBUS
...
\hspace{5mm}
\begin{GrilleSutom}%
		[Style=alt,Unite=0.75,Arrondi=0,Couleurs={cyan,orange,violet}]{REBUS}
	ABRIS
	ROUTE
	RUDES
	REBUS
